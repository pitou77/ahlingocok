$(document).ready(function(){
  ...
  $('a[href^="https://mediafire.com/"]').each(function(){
	...
	document.getElementById("downloadbtn").innerHTML = '<a href="/p/yakin-ingin-mendownload.html?id='+tautan+'"><img alt="Download" src="https://1.bp.blogspot.com/--P4-hAsQK9U/U1W9v0oQ0yI/AAAAAAAABfU/uGg5Lffp_Es/w104/Download.png"/></a>';
	 });
 });
